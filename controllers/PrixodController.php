...
class PrixodController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            Yii::$app->response->format = Response::FORMAT_JSON;
             if($model->load($request->post()) && $model->save()){
                return $this->redirect(['/prixod-goods/prixod-create','number'=>$model->id]);

            }else{           
                return [
                    'title'=> "Создать новый приход",
            ...
            */
            if ($model->load($request->post()) &&  $model->save()) {
                return $this->redirect(['/prixod-goods/create','number'=>$model->id]);
             } else {
    ...
    /**
     * Delete an existing Prixod model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Prixod model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
